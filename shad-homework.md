...
Для решения задачи понадобится хранилище контекстов сессий с эффективным поиском по имени сессии.
...
Могут ли возникнуть проблемы из-за просроченных тайм-аутов, преждевременных пробуждений, перевода часов, дребезга и т.д.
